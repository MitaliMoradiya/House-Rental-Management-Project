...
ResultSet rs = s.executeQuery("select * from tbl_property ");
...
String id = request.getParameter("fav");

PreparedStatement ps = con.prepareStatement("insert into tbl_fav (prid,rid) values(?,?)");
ps.setString(1,id);
ps.setString(2,sessionid);

int x = ps.executeUpdate();

response.sendRedirect("fav.jsp");
...
<%
                                            ...
                                            <td class="product-addtocart">
                                                ...
                                                <a class="btn btn-primary" href="fav.jsp">FAV</i></a>
                                           </td>
